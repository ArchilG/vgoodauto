	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		<div class="col-md-2">
				...
				<div class="ed_izm">
					...
					<?=$arItem['PROPERTIES']['ED_IZM']['VALUE']?>
				</div>							
						</td>
						<td>
...
<div class="tt" el="<?=$arItem['ID']?>">
    ...
    <button class="btn btn-default  btn-sm car"<?//=$checked;?> autocomplete="off" id="compareid_<?=$arResult['ID'];?>" onclick="compare_tov_(<?=$arItem['ID'];?>,<?=$arItem['PROPERTIES']['PRICE']['VALUE'];?>);" style="width: 100%; /*font-size: 20px;*/ padding: 8px 10px 8px;">
	...
	function compare_tov_(id, price)
{
  ...
  // alert('a');
		...
		else
		{
			...
			<div class="v_nalichii" style=" display: none;"><i class="fa fa-check"></i> <?=GetMessage('SKLAD_YES')?></div>
			<?else:?>
			<div class="no_v_nalichii" style=" display: none;"><i class="fa fa-clock-o"></i> <?=GetMessage('OGIDAETSYA')?></div>
			<?endif?>
		</div>
