...
<?
	...
	?>
	<div class="col-md-4 col-sm-12 col-xs-12 akciya" <? if($APPLICATION->GetCurPage(false) !== SITE_DIR.'akcii/'): ?> style="padding: 0"<?else:?>style="margin-bottom: 30px;"<?endif?>   id="<?=$this->GetEditAreaId($arElement['ID']);?>">
