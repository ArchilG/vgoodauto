...
?>
			...
			<a  id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="catalog_projects_more" href="<? echo $arSection['SECTION_PAGE_URL']; ?>">
				<div class="col-md-4 col-sm-6 catalog_projects_index_one ">
					<div>
<div style="background: url(<?=$arSection['PICTURE']['SRC']?>) no-repeat center center; background-size: contain; height: 180px; width: auto;  margin: 20px 15px 0;">
		</div>						
