...
$MESS["OGIDAETSYA"] = "Ожидается";
$MESS["SKLAD_YES"] = "В наличии";


$MESS["MORE_OPIS"] = "Описание";
$MESS["MORE_KHAR"] = "Дополнительные характеристики";
$MESS["MORE_CONTENT"] = "Обзоры";
$MESS["MORE_DOWNLOAD"] = "Полезная информация";
$MESS["MORE_VIDEO"] = "Видео";
$MESS["MORE_COMMENTS"] = "Отзывы";

$MESS["PR_NEW"] = "Новиинка";
$MESS["PR_HIT"] = "Хит продаж";
$MESS["PR_RECOM"] = "Рекомендуем";
$MESS["PR_RASPROD"] = "Распродажа!";
$MESS["ADD_FAV"] = "Отложить";

$MESS["CT_BCS_TPL_MESS_PRODUCT_NOT_AVAILABLE"] = "Под заказ";
$MESS["TITLE_RECOM"] = "С этим товаром рекомендуем";
$MESS["ONE_CLICK"] = "Купить в один клик";

$MESS["DOWNLOAD_NAME"] = "Имя";
$MESS["DOWNLOAD_FILE"] = "Файл";
$MESS["DOWNLOAD_SIZE"] = "Размер";
$MESS["DOWNLOAD_GO"] = "Скачать";

$MESS["PAGE_OPLATA"] = "Оплата";
$MESS["PAGE_DOSTAVKA"] = "Доставка";
$MESS["PAGE_GARANTII"] = "Гарантии";
