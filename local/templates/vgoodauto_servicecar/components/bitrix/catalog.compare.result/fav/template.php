...
<?
		...
		{
			?><span class="price"><? echo $arElement['MIN_PRICE']['PRINT_DISCOUNT_VALUE']; ?></span><?
		}
?>
		</td>
		<td style="vertical-align: middle;">
						...
						<noindex>
						<a class="btn btn-default btn-sm" href="<?=$arElement["BUY_URL"]?>" rel="nofollow"><i class="fa fa-shopping-cart"></i> <?=GetMessage("CATALOG_COMPARE_BUY"); ?></a></noindex>
