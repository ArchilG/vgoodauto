...
<?= GetMessage('SORT_TITLE') ?>
                        ...
                        if ($_GET['sort'] !== 'NAME'):?>
                            ...
                            <a class="btn btn-xs <? if ($_GET["sort"] == "NAME" && $_GET["method"] == "asc"):?>actived<? endif; ?>"
                               href="<?= $url ?>">
                        ...
                        if ($_GET['sort'] !== 'catalog_PRICE_1'):?>
                            ...
                            <a class="btn btn-xs <? if ($_GET["sort"] == "catalog_PRICE_1" && $_GET["method"] == "desc"):?>actived<? endif; ?>"
                               href="<?= $url ?>">
                        ...
                        <? if ($_GET['sort'] == 'catalog_PRICE_1' && $_GET['method'] == 'asc'): ?>
                            ...
                            <a class="btn btn-xs <? if ($_GET["sort"] == "catalog_PRICE_1" && $_GET["method"] == "asc"): ?>actived<? endif; ?>"
                               href="<?= $url ?>">
                                <i class="fa fa-sort-amount-asc"></i> <?= GetMessage('SORT_PRICE') ?>
                            </a>
                        ...
                        <a class="btn btn-xs <? if ($_GET["sort"] == "show_counter"): ?> actived<? endif; ?>"
                           href="<?= $url ?>">
