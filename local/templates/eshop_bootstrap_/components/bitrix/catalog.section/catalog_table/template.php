...
<?endif?>
	...
	// ---------------------------  Скидка 
		...
		{
			?>
			<div style="display: none;" id="<? echo $arItemIDs['DSC_PERC']; ?>1" class="proc_skidki" style="display:<? echo (0 < $minPrice['DISCOUNT_DIFF_PERCENT'] ? '' : 'none'); ?>;"><div>-<? echo $minPrice['DISCOUNT_DIFF_PERCENT']; ?>%</div></div>
			<?
		}
	// ---------------------------  .Скидка 
		?>
	...
	<?=TruncateText($productTitle,150);?>
		...
		{
?>
			<table class="table svoistva" style="display: none;">
			<?
...
<a id="<? echo $arItemIDs['QUANTITY_UP']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small" rel="nofollow"><i class="fa fa-plus"></i></a>
		...
		<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>">
			<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="btn btn-danger  btn-sm car" href="javascript:void(0)" rel="nofollow"><?
...
<div class="btn-group" data-toggle="buttons" style="width: 100%" >
  ...
  <label class="btn <?=$active?>">
    <input <?=$checked;?> type="checkbox" autocomplete="off" id="compareid_<?=$arItem['ID'];?>" onchange="compare_tov(<?=$arItem['ID'];?>,<?=$arItem['IBLOCK_ID']?>);"> <i class="fa fa-bar-chart"></i> <? echo $compareBtnMessage; ?>
  </label>
...
?>
  <label class="btn <?=$active?>">
    <input checked type="checkbox" autocomplete="off" id="favid_<?=$arItem['ID'];?>" onchange="fav_tov(<?=$arItem['ID'];?>,<?=$arItem['IBLOCK_ID']?>);"><i class="fa fa-heart-o"></i> <?=GetMessage('ADD_FAV')?>
  </label>
	</div> 
...
<script type="text/javascript">   
    $(document).ready(function(){
       $(".tt").click(function(){
        ...
        $(tmp)
                .clone()
                .css({'position' : 'absolute', 'z-index' : '11100', top: $(this).offset().top, left:$(this).offset().left-110})
                .appendTo("body")
                .animate({opacity: 0.5,
