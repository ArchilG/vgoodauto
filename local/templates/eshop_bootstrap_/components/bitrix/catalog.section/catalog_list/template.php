    ...
    <div class="row1">
            ...
            <div class="row prod_plitki">
                ...
                <div class="row prod_plitki">
                    ...
                    <div class="col-md-12" id="<? echo $strMainID; ?>" <?
                    if ($APPLICATION->GetCurPage(false) == '/'):?> style="background: none"<?endif ?>>


                        <div class="col-md-3 no-padding picture">
                            <?
                            // ---------------------------  Скидка
                            if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT']) {
                                ?>
                                <div id="<? echo $arItemIDs['DSC_PERC']; ?>1" class="proc_skidki"
                                     style="display:<? echo(0 < $minPrice['DISCOUNT_DIFF_PERCENT'] ? '' : 'none'); ?>;">
                                    <div>-<? echo $minPrice['DISCOUNT_DIFF_PERCENT']; ?>%</div>
                                </div>
                                <?
                            }
                            // ---------------------------  .Скидка
                            ...
                            <? if ($APPLICATION->GetCurPage(false) !== '/'): ?>
                                <div class="shildiki">
                                    ...
                                    <?
                                    if ($arItem["PROPERTIES"]["PR_NEW"]["VALUE"] == "Y" && ($APPLICATION->GetCurPage() !== '/' || isset($sdvig))): ?>
                                        <div class="new"><?= GetMessage('PR_NEW') ?></div>
                                    <?endif ?>

                                    <?
                                    if ($arItem["PROPERTIES"]["PR_HIT"]["VALUE"] == "Y"): ?>
                                        <div class="hit"><?= GetMessage('PR_HIT') ?></div>
                                    <?endif ?>

                                    <?
                                    if ($arItem["PROPERTIES"]["PR_RECOM"]["VALUE"] == "Y"): ?>
                                        <div class="recom"><?= GetMessage('PR_RECOM') ?></div>
                                    <?endif ?>

                                    <?
                                    if ($arItem["PROPERTIES"]["PR_RASPROD"]["VALUE"] == "Y"): ?>
                                        <div class="rasprod"><?= GetMessage('PR_RASPROD') ?></div>
                                    <?endif ?>
                                </div>
                            <?endif ?>

                            <a class="fancybox" rel="gallery-<?=$arItem['ID']?>" title="<?=$productTitle?>" href="<?= $arItem['DETAIL_PICTURE']['SRC'] ?>"><img src="<?= $arItem['PREVIEW_PICTURE']['SRC'] ?>"></a>
                            <?if(!empty($arItem['MORE_PHOTO'])):?>
                                <div class="clearfix"></div>
                                <?
                                foreach ($arItem['MORE_PHOTO'] as $photo) {
                                    ?><a class="fancybox mr5" rel="gallery-<?=$arItem['ID']?>" title="<?=$productTitle?>" href="<?=$photo?>"><i class="fa fa-picture-o" aria-hidden="true"></i></a><?
                                }?>
                            <?endif?>
                        </div>
                        ...
                        <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $productTitle; ?>">
                            <div class="col-md-7 prod_title">
                                <?= TruncateText($productTitle, 150); ?><?//=$arResult['NAME']
                                ?>
                        </a>
                        ...
                        <? else:?>
                            <div class="no_v_nalichii"><i class="fa fa-clock-o"></i> <?= GetMessage('OGIDAETSYA') ?>
                            </div>
                        <?endif ?>
                    ...
                    if ($arItem['SECOND_PICT']) {
                        ...
                        <a data-toggle="popover<?= $arItem['ID'] ?>" id="<? echo $arItemIDs['SECOND_PICT']; ?>"
                           href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="bx_catalog_item_images_double"
                        ...
                        <div class="col-md-2 plitki_cart">
                            ...
                            <div class="cena_nalichie">
                                ...
                                <table width="100%">
                                                    ...
                                                    <div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price">
                                                        ...
                                                        if (!empty($minPrice)) {
                                                            ...
                                                            if ('N' == $arParams['PRODUCT_DISPLAY_MODE'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS'])) {
                                                                ...
                                                                $price_main = $minPrice['PRINT_DISCOUNT_VALUE'];
                                                            ...
                                                            if ('Y' == $arParams['SHOW_OLD_PRICE'] && $minPrice['DISCOUNT_VALUE'] < $minPrice['VALUE']) {
                                                                ...
                                                                $price_old = $minPrice['PRINT_VALUE'];;
                                                                // $price =  str_replace ( '<i class="fa fa-rub"></i>', '', $price);
                                                                ?><span><? echo $price_old; ?></span><?
                                                            }
                                    ...
                                    <tr>
                                        <td class="nalichie" align="center">
                            ...
                            // if ($arItem['CAN_BUY'])
                            if ($arItem["CATALOG_QUANTITY"] || $sklad_no_pokupka == 'Y')
                            {
                                if ('Y' == $arParams['USE_PRODUCT_QUANTITY']) {
                                    ?>
                                    <div class="bx_catalog_item_controls_blockone1">
                                        <div class="kolichectvo" style="width: 40%; padding-right: 5px;">

                                            <table>
                                                <tr>
                                                    <td width="25%" style="background: #f2f2f2">
                                                        <a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>"
                                                           href="javascript:void(0)"
                                                           class="bx_bt_button_type_2 bx_small" rel="nofollow"><i
                                ...
                                <div class="tt" el="<?= $arItem['ID'] ?>">
                                    <div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>">
                                        <a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="btn btn-danger  btn-sm car"
			...
			<?
                            ...
                            ?></span></div-->
                            <a class="btn btn-danger btn-sm zakaz" href="#" data-toggle="modal"
                               data-target="#callback_zakaz_<?= $arItem['ID'] ?>" rel="nofollow" style="width: 100%;">
                                <i class="fa fa-clock-o"></i> <?= GetMessage('CT_BCS_TPL_MESS_PRODUCT_NOT_AVAILABLE') ?>
                            </a>

                            <?

                            form_zakaz($arItem['ID'], $arItem['NAME'], $price_main, $arItem['PREVIEW_PICTURE']['SRC'], GetMessage('CT_BCS_TPL_MESS_PRODUCT_NOT_AVAILABLE'));
...
<?
    ...
    if ($arParams["DISPLAY_BOTTOM_PAGER"]) {
        ?>
        <div class="col-md-12" style="margin: 0 15px 0 15px; padding-right: 40px;">
            <? echo $arResult["NAV_STRING"]; ?>
        </div>
        <?
    }
...
<? if ($arResult["DESCRIPTION"] && $APPLICATION->GetCurPage() !== SITE_ID): ?>
    <!-- <div class="col-md-12"> -->
    <div class="col-md-12" style="margin: 0 15px 0 15px">
