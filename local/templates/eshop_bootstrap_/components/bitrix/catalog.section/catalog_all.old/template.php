	...
	if (!empty($arResult['SKU_PROPS']))
	{
		foreach ($arResult['SKU_PROPS'] as &$arProp)
		{
			...
			if ('TEXT' == $arProp['SHOW_MODE'])
			{
				...
				$templateRow .= '<div style="display: none;" class="'.$strClass.'" id="#ITEM#_prop_'.$arProp['ID'].'_cont">'.
...
<?if($APPLICATION->GetCurPage(false) == '/'):?>
	<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 prod_plitki" style="padding-bottom: 30px">
<?else:?>	
	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6  prod_plitki" style="padding-bottom: 30px">
<?endif?>
...
<div id="<? echo $arItemIDs['PRICE']; ?>" class="cena">
<?
	if (!empty($minPrice))
	{
	...
	?>
			...
			<div class="v_nalichii"><i class="fa fa-check"></i> Есть на складе
...
var <? echo $strObName; ?> = new JCCatalogSection(<? echo CUtil::PhpToJSObject($arJSParams, false, true); ?>);
	...
	else
	{
		...
		<div class="kolichectvo" style="width: 40%; padding-right: 5px;">
			...
			<table>
				<tr>
					<td width="30%" style="background: #f2f2f2">
						<!-- <a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small" rel="nofollow">-</a> -->
						<a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small" rel="nofollow"><i class="fa fa-minus"></i></a>
					</td>
					<td width="40%">
					<input type="text" class="bx_col_input" id="<? echo $arItemIDs['QUANTITY']; ?>" name="<? echo $arParams["PRODUCT_QUANTITY_VARIABLE"]; ?>" value="<? echo $arItem['CATALOG_MEASURE_RATIO']; ?>">
						<!-- <input type="text" class="bx_col_input" id="bx_3966226736_338_quantity" name="quantity" value="1"> -->
					</td>
					<td width="30%" style="background: #f2f2f2">
						<a id="<? echo $arItemIDs['QUANTITY_UP']; ?>" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small" rel="nofollow"><i class="fa fa-plus"></i></a>
						<!-- <a id="bx_3966226736_338_quant_up" href="javascript:void(0)" class="bx_bt_button_type_2 bx_small" rel="nofollow"><i class="fa fa-plus"></i></a> -->
					</td>
				</tr>
			</table>
		...
		<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo" style="display: <? echo ($canBuy ? '' : 'none'); ?>;">
			...
			<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="btn btn-danger btn-sm <?if($arParams['USE_PRODUCT_QUANTITY'] == 'Y'):?>car<?else:?>car_no_kol<?endif?>" href="javascript:void(0)" rel="nofollow">
